...
//"void main()\n"
//"{\n"
//"color = ourColor; // The color yellow \n"
//"}\n\0";
//
...
//
//	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(GLfloat), (GLvoid*)(3 * sizeof(GLfloat)));	// Vertex attributes stay the same
...
//		GLuint color = glGetUniformLocation(shaderProgramYellow, "ourColor");
//		glUseProgram(shaderProgramYellow);
//		glUniform4f(color, 0.0f, greenValue, 0.0f, 0.0f);
